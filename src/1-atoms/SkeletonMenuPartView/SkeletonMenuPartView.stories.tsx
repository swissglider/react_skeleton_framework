...
export default {
    title: 'Internal/atoms/SkeletonMenuPartView',
    component: SkeletonMenuPartView,
    argTypes: {
        menuPartName: {
...
} as ComponentMeta<typeof SkeletonMenuPartView>;

const Template1: ComponentStory<typeof SkeletonMenuPartView> = (args) => {
    return <SkeletonMenuPartView {...args} />;
};
